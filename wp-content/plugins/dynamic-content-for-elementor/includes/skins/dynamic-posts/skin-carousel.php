...
class SkinCarousel extends \DynamicContentForElementor\Includes\Skins\SkinBase
{
    ...
    {
        return ['dce-dynamicPosts-carousel', 'swiper'];
    }
    ...
    protected function render_navigation()
    {
        ...
        $this->get_parent()->set_render_attribute('carousel-left', ['class' => ['swiper-button-left', 'left-' . $this->get_parent()->get_id()], 'role' => 'button', 'tabindex' => '0', 'aria-label' => esc_attr__('Previous slide', 'dynamic-content-for-elementor')]);
        $this->get_parent()->set_render_attribute('carousel-right', ['class' => ['swiper-button-right', 'right-' . $this->get_parent()->get_id()], 'role' => 'button', 'tabindex' => '0', 'aria-label' => esc_attr__('Next slide', 'dynamic-content-for-elementor')]);
        // Add Arrows
