...
class TextEditorWithTimber extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('timber_legacy_notice', ['type' => Controls_Manager::NOTICE, 'notice_type' => 'warning', 'content' => esc_html__('This feature is deprecated. Please use Dynamic Shortcodes instead.', 'dynamic-content-for-elementor')]);
