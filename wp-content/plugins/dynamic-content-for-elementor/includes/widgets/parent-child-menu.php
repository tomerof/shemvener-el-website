...
class ParentChildMenu extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('dynamic_parentchild', ['label' => esc_html__('Auto Detect Hierarchy', 'dynamic-content-for-elementor'), 'description' => esc_html__('Automatically detect parent and child pages based on the current page', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '']);
        ...
        $this->add_control('use_second_level', ['label' => esc_html__('Show Second Level', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes']);
        $this->add_control('exclude_io', ['label' => esc_html__('Exclude Current Page', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes']);
        ...
        $this->add_control('only_children', ['label' => esc_html__('Show Only Children', 'dynamic-content-for-elementor'), 'description' => esc_html__('Hide the parent level links and show only child pages', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'condition' => ['no_siblings!' => '']]);
        ...
        $this->add_control('blockwidth_enable', ['label' => esc_html__('Force Full Width', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'condition' => ['show_border' => '2']]);
        ...
        $this->start_controls_tabs('menu_colors_tabs', ['condition' => ['show_childlist!' => '']]);
        $this->start_controls_tab('menu_colors_normal_tab', ['label' => esc_html__('Normal', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu a' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list', 'selector' => '{{WRAPPER}} .dce-menu ul.first-level li']);
        $this->end_controls_tab();
        $this->start_controls_tab('menu_colors_hover_tab', ['label' => esc_html__('Hover', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color_hover', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu a:hover' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list_hover', 'selector' => '{{WRAPPER}} .dce-menu ul.first-level li a:hover']);
        $this->end_controls_tab();
        $this->start_controls_tab('menu_colors_active_tab', ['label' => esc_html__('Active', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color_active', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu ul li a.active' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list_active', 'selector' => '{{WRAPPER}} .dce-menu ul.first-level li a.active']);
        $this->end_controls_tab();
        ...
        $this->start_controls_tabs('menu_colors_tabs_2', ['condition' => ['show_childlist!' => '', 'use_second_level' => 'yes']]);
        $this->start_controls_tab('menu_colors_normal_tab_2', ['label' => esc_html__('Normal', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color_2', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu ul.second-level a' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list_2', 'selector' => '{{WRAPPER}} .dce-menu ul.second-level li']);
        $this->end_controls_tab();
        $this->start_controls_tab('menu_colors_hover_tab_2', ['label' => esc_html__('Hover', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color_hover_2', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu ul.second-level a:hover' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list_2_hover', 'selector' => '{{WRAPPER}} .dce-menu ul.second-level li a:hover']);
        $this->end_controls_tab();
        $this->start_controls_tab('menu_colors_active_tab_2', ['label' => esc_html__('Active', 'dynamic-content-for-elementor')]);
        $this->add_control('menu_color_active_2', ['label' => esc_html__('Text Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'default' => '', 'selectors' => ['{{WRAPPER}} .dce-menu ul.second-level li a.active' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'typography_list_2_active', 'selector' => '{{WRAPPER}} .dce-menu ul.second-level li a.active']);
        $this->end_controls_tab();
        $this->end_controls_tabs();
        ...
        $this->add_control('menu_space', ['label' => esc_html__('Title Spacing', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['size' => 0], 'range' => ['px' => ['min' => 0, 'max' => 100]], 'selectors' => ['{{WRAPPER}} .dce-menu .dce-parent-title' => 'margin-bottom: calc( {{SIZE}}{{UNIT}} / 2);', '{{WRAPPER}} .dce-menu hr' => 'margin-bottom: calc( {{SIZE}}{{UNIT}} / 2);', '{{WRAPPER}} .dce-menu div.box' => 'padding: {{SIZE}}{{UNIT}};'], 'condition' => ['show_childlist!' => '']]);
    ...
    protected function safe_render()
    {
        ...
        echo '<nav class="' . esc_attr('dce-menu ' . $clssStyleMenu) . '">';
        if ($settings['show_border'] == 2) {
            echo '<div class="box">';
        }
        if ($settings['show_parent']) {
            $html_tag = Helper::validate_html_tag($settings['title_html_tag']);
            echo '<' . $html_tag . ' class="dce-parent-title"><a href="' . esc_url((string) get_permalink($id_page)) . '">' . wp_kses_post(get_the_title($id_page)) . '</a></' . $html_tag . '>';
            ...
            foreach ($children as $page) {
                ...
                if (!$settings['exclude_io'] || $page->ID != $id_page) {
                    if ($linkActive || !$settings['no_siblings']) {
                        echo '<li class="' . esc_attr('item-' . $page->ID) . '">';
                        if (!$settings['only_children']) {
                            echo '<a href="' . esc_url((string) get_permalink($page->ID)) . '"' . $linkActive . '>' . wp_kses_post($page->post_title) . '</a>';
                        }
                        if ($settings['use_second_level']) {
                            ...
                            if (\count($children2) > 0) {
                                ...
                                foreach ($children2 as $page2) {
                                    ...
                                    echo '<li class="' . esc_attr('item-' . $page2->ID) . '"><a href="' . esc_url((string) get_permalink($page2->ID)) . '"' . $linkActive . '>' . wp_kses_post($page2->post_title) . '</a></li>';
                                }
                                echo '</ul>';
                            }
                        }
