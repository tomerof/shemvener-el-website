...
class Events extends \DynamicContentForElementor\Extensions\DynamicVisibility\Triggers\Base
{
    ...
    public function register_controls($element)
    {
        ...
        $element->add_control('dce_visibility_click', ['frontend_available' => \true, 'label' => esc_html__('Trigger on this element', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'description' => esc_html__('Type here the Selector in jQuery format. For example #name', 'dynamic-content-for-elementor'), 'ai' => ['active' => \false], 'dynamic' => ['active' => \true], 'condition' => ['dce_visibility_dom!' => '']]);
        ...
        $element->add_control('dce_visibility_click_other', ['frontend_available' => \true, 'label' => esc_html__('Hide other elements', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'description' => esc_html__('Type here the Selector in jQuery format. For example .elements', 'dynamic-content-for-elementor'), 'ai' => ['active' => \false], 'condition' => ['dce_visibility_dom!' => '', 'dce_visibility_click!' => '']]);
