...
class Features {
	 ...
	 * @var array<string,string>
	 */
	private static $third_party_groups = [
		'ACF' => 'acf',
		'WOO' => 'woocommerce',
		'METABOX' => 'metabox',
		'TOOLSET' => 'toolset',
	...
	public static function get_widgets_groups() {
		// Fixed order groups
		$core_top = [
			'LIST' => esc_html__( 'Query & Lists', 'dynamic-content-for-elementor' ),
			'CONTENT' => esc_html__( 'Utilities', 'dynamic-content-for-elementor' ),
		];
		...
		$core_bottom = [
			...
			'WEBGL' => esc_html__( '3D & Effects', 'dynamic-content-for-elementor' ),
			'SVG' => 'SVG',
			'POST' => esc_html__( 'Post Template', 'dynamic-content-for-elementor' ),
		];

		// Split third-party into active (top) and inactive (bottom)
		$active_third_party = [];
		$inactive_third_party = [];
		foreach ( $third_party_labels as $key => $label ) {
			$plugin_slug = self::$third_party_groups[ $key ];
			if ( Helper::is_plugin_active( $plugin_slug ) ) {
				$active_third_party[ $key ] = $label;
			} else {
				$inactive_third_party[ $key ] = $label;
			}
		}

		return $core_top + $active_third_party + $core_bottom + $inactive_third_party;
	}
	...
	public static function get_all_features_data() {
		return [
			...
			'ext_form_address_autocomplete' => [
				...
				'category' => 'FORM',
				'legacy' => true,
				'replaced_by' => 'ext_google_address_autocomplete_field',
				'tag' => [ 'enchanted' ],
			...
			'ext_form_country_field' => [
				'name' => 'dce_extension_form_country_field',
				'type' => 'extension',
				'class' => 'Extensions\CountryField',
				'category' => 'FORM',
				'title' => esc_html__( 'Country Field for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Add a country selection field to your forms', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-country-field',
				'plugin_depends' => [ 'elementor-pro' ],
				'doc_url' => 'country-field-select-form/',
			],
			'ext_form_amount' => [
			...
			'ext_form_international_phone' => [
				'name' => 'dce_extension_form_international_phone',
				'type' => 'extension',
				'class' => 'Extensions\InternationalPhone',
				'category' => 'FORM',
				'title' => esc_html__( 'International Phone Field for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Add an International Phone Field with country selection to Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-international-phone',
				'plugin_depends' => [ 'elementor-pro' ],
				'doc_url' => 'international-phone-field/',
			],
			'ext_form_rating' => [
				'name' => 'dce_extension_form_rating',
				'type' => 'extension',
				'class' => 'Extensions\Rating',
				'category' => 'FORM',
				'title' => esc_html__( 'Rating Field for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Add a star rating field to Elementor Pro Form.', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-rating',
				'plugin_depends' => [ 'elementor-pro' ],
				'doc_url' => 'rating-field-form',
			],
			...
			'ext_form_woo_cart' => [
				'name' => 'dce_extension_form_woo_cart',
				'type' => 'extension',
				'class' => 'Extensions\\WooCartAction',
				'category' => 'FORM',
				'title' => esc_html__( 'WooCommerce Add to Cart for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Add products to WooCommerce cart after form submission by reading product IDs from a field', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-woo-add-to-cart',
				'plugin_depends' => [ 'elementor-pro', 'woocommerce' ],
				'doc_url' => 'woo-add-to-cart-form',
			],
			'ext_form_icons' => [
			...
			'ext_form_step' => [
				...
				'type' => 'extension',
				'class' => 'Extensions\StepAutoScroll',
				'category' => 'FORM',
				'title' => esc_html__( 'Step Auto-Scroll for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Automatically scroll to top when navigating between form steps', 'dynamic-content-for-elementor' ),
			...
			'ext_google_address_autocomplete_field' => [
				'name' => 'dce_google_address_autocomplete_field',
				'type' => 'extension',
				'class' => 'Extensions\GoogleAddressAutocompleteField',
				'category' => 'FORM',
				'title' => esc_html__( 'Google Address Autocomplete Field for Elementor Pro Form', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Add an address field with Google Places autocomplete that can auto-fill other form fields with address components', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-google-address',
				'plugin_depends' => [ 'elementor-pro' ],
				'doc_url' => 'google-address-autocomplete-field-form/',
			],
			'ext_hidden_label' => [
			...
			'ext_token' => [
				...
				'extension_type' => 'dynamic-tag',
				'legacy' => true,
				'replaced_by_custom_message' => esc_html__( 'This feature is deprecated. Use Dynamic Shortcodes instead.', 'dynamic-content-for-elementor' ),
			...
			'wdg_woo_product_variations' => [
				...
				'icon' => 'icon-dce-woo-products-variations',
				'plugin_depends' => [ 'woocommerce' ],
