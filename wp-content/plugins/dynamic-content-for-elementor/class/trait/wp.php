...
trait Wp
{
    ...
    {
        global $wpdb;
        $protected = ['session_tokens', 'default_password_nonce', '_new_email', '_application_passwords', $wpdb->prefix . 'capabilities', $wpdb->prefix . 'user_level'];
        return \in_array($key, $protected, \true);
    }
