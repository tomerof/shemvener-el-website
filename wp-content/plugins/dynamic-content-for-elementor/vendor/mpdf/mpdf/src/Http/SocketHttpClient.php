...
use DynamicOOOS\Mpdf\PsrHttpMessageShim\Response;
use DynamicOOOS\Mpdf\PsrHttpMessageShim\Stream;
use DynamicOOOS\Mpdf\PsrLogAwareTrait\PsrLogAwareTrait;
use DynamicOOOS\Psr\Http\Message\RequestInterface;
use DynamicOOOS\Psr\Log\LoggerInterface;
class SocketHttpClient implements \DynamicOOOS\Mpdf\Http\ClientInterface, \DynamicOOOS\Psr\Log\LoggerAwareInterface
{
