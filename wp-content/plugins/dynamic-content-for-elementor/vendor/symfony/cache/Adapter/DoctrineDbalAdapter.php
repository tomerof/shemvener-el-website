...
use DynamicOOOS\Doctrine\DBAL\ArrayParameterType;
use DynamicOOOS\Doctrine\DBAL\Configuration;
...
use DynamicOOOS\Doctrine\DBAL\Exception as DBALException;
use DynamicOOOS\Doctrine\DBAL\Exception\TableNotFoundException;
use DynamicOOOS\Doctrine\DBAL\ParameterType;
use DynamicOOOS\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use DynamicOOOS\Doctrine\DBAL\Schema\Schema;
use DynamicOOOS\Doctrine\DBAL\ServerVersionProvider;
use DynamicOOOS\Doctrine\DBAL\Tools\DsnParser;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \DynamicOOOS\Doctrine\DBAL\Platforms\SQLServer2012Platform:
