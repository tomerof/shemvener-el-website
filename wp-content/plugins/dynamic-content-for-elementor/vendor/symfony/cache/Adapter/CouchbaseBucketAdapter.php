...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\DynamicOOOS\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \DynamicOOOS\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \DynamicOOOS\CouchbaseCluster($connectionString);
